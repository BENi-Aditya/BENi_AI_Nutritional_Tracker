...
SAVE_PATH = "/Users/tripathd/Downloads/Nutrition/Barcode_scans"
    ...
    try:
        ...
        if product_info:
            ...
            scanned_data = {
                ...
                'expiration_date': product_info.get('expiration_date', 'Not specified'),
                'calories': product_info.get('nutriments', {}).get('energy-kcal_100g', 'Not specified'),
                'allergens': product_info.get('allergens_tags', []),
                'ingredients': product_info.get('ingredients_text', 'Not specified'),
